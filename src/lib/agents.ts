...
export const MOCK_BUILTIN_AGENTS: AgentRecord[] = [
  ...
  mockBuiltinAgent({ id: "meeting-source-review", labelKey: "agents.builtin.meetingSourceReview", skillName: "meeting-source-review", kind: "background", permissionMode: "plan", prompt: "외부 회의록의 참가자 맥락과 요약을 검토하고, 근거가 있는 수정 제안만 반환. 원문 파일을 수정하거나 회의록 파일을 생성하지 말 것." }),
