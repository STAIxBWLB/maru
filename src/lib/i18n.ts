...
const ko: Record<string, string> = {
  ...
  "inbox.settings.description": "이 볼트의 인박스 위치, 인식할 소스, 그리고 Gmail용 gws CLI 경로를 지정합니다.",
  "inbox.settings.root.label": "인박스 루트 (볼트 상대 경로)",
...
const en: Record<string, string> = {
  ...
  "editor.tabs.close": "Close {title} tab",
  ...
  "inbox.settings.description": "Set the inbox root, recognized sources, and the gws CLI path for this vault.",
  "inbox.settings.root.label": "Inbox root (vault-relative)",
