...
const ko: Record<string, string> = {
  ...
  "meetings.transcript.description": "녹취 파일을 선택하고 회의록 생성 스킬을 백그라운드로 실행합니다.",
  ...
  "meetings.progress.clearDone": "완료 로그 Clear",
  "meetings.progress.cleared": "로그를 가렸습니다.",
...
const en: Record<string, string> = {
  ...
  "meetings.transcript.description": "Select transcript files and run the meeting-note skill in the background.",
  ...
  "meetings.progress.clear": "Clear",
  "meetings.progress.clearDone": "Clear done",
  "meetings.progress.cleared": "Run hidden from the list.",
