...
import { listMeetingSourceSessions, listMeetingCorrectionExamples, saveMeetingSourceDraft, confirmMeetingSource, readMeetingSourceSession, type SourceSession } from "../../lib/meetingSources";
...
vi.mock("../../lib/meetingSources", async (original) => ({
  ...
  confirmMeetingSource: vi.fn(), readMeetingSourceSession: vi.fn(),
}));
...
function sourceSession(): SourceSession {
  return { id: crypto.randomUUID(), revision: "r1", createdAt: "2026-09-13", updatedAt: "2026-09-13", versions: [], outputLinks: [], draft: {
    title: "회의 검토", sources: [{ id: "note", name: "Plaud.md", kind: "note", originalText: "원문", text: "원문", originalHash: "hash" }],
