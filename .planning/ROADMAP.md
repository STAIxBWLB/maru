...
**Plans**: 5 plans in 1 wave (all file-disjoint; 07-01 leads as the phase tracer)

Plans:
**Wave 1**

- [ ] 07-01-PLAN.md - SEC-02 sanitizer guard: check-dom-sanitizer.mjs, red-then-green proof, make verify wiring (phase tracer)
...
| 7. Guardrails Before Churn | 0/5 | Not started | - |
