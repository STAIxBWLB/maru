...
Structural debt paydown for Maru's verification signal, shared Rust invariants,
typed IPC errors, editor surfaces, and application shell. The milestone kept
visible behavior stable while making future refactors and mode additions safer.

---

# Archived Roadmap Detail
