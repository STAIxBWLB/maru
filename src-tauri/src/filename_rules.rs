...
// handled by the OS at write time; this module only screens characters.
...
mod tests {
    ...
    #[test]
    fn accepts_korean_filenames() {
        assert_eq!(validate_filename_stem("회의록-2026"), Ok(()));
        assert_eq!(validate_folder_name("프로젝트"), Ok(()));
        assert_eq!(validate_filename_stem("제주한라대-RISE"), Ok(()));
    }
