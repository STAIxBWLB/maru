...
The current product release is **v1.1.2, Truthful Retry**. Releases
...
| Area | State | Evidence |
|------|-------|----------|
| Product release | v1.1.2 | Signed desktop bundles and standalone CLI for macOS, Windows, and Linux |
