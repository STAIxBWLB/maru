...
The current product release is **v1.1.8, Reference Walk**. Releases
...
| Area | State | Evidence |
|------|-------|----------|
| Product release | v1.1.8 | Signed desktop bundles and standalone CLI for macOS, Windows, and Linux |
