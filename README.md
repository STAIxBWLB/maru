...
1. **Evidence Binder tab (M5)** — right-pane binder state at `<workspace>/.anchor/binder/<doc-id>.json`, seeded from inbox-processed attachments, evidence sidecars, and `kordoc_lite` document detection/form-field previews.
