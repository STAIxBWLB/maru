...
1. **Evidence Binder tab (M5)** — right-pane binder state at `<workspace>/.anchor/binder/<doc-id>.json`, seeded from inbox-processed attachments and evidence sidecars.
2. **Evidence-to-section binding model** — prepare the W14 frontmatter shape for section/KPI/submission-checklist bindings without moving binaries to Hub.
