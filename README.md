...
The current product release is **v1.1.11, Lighter Start**. Releases
...
| Area | State | Evidence |
|------|-------|----------|
| Product release | v1.1.11 | Signed desktop bundles and standalone CLI for macOS, Windows, and Linux |
