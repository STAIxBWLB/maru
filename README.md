...
The current product release is **v1.1.9, Tighter Bundle**. Releases
...
| Area | State | Evidence |
|------|-------|----------|
| Product release | v1.1.9 | Signed desktop bundles and standalone CLI for macOS, Windows, and Linux |
