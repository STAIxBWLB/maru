...
- Rust core **owns** vault FS / cache / git / frontmatter / inbox scan/watch/classification / Gmail `gws` bridge / `.anchor/settings.json` / Claude inbox subprocess / integrated terminal PTY sessions.
